...
3. 对于因特殊原因导致的无法现场提交作业的场合, 如课程冲突, 请假离校等, 提交方式可替代为以照片、扫描件或电子版的形式将相应作业发送至邮箱, 邮件标题为`高等代数(II)第x次作业-姓名-学号`, 其中`x`替换为相应作业编号(以下表为准). 附件仅接受单个 pdf 文件(多个文件请自行合并), 命名与标题一致. 批阅好的作业将原路返回.
